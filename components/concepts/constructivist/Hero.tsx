    ...
    >
      <div className="relative mx-auto max-w-[1440px]">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-start lg:gap-10">
          {/* Intro — solid ultramarine block, one of the few deliberate accent uses */}
          ...
          {/* Numeral easter egg + duotone image, offset up on desktop for grid-break overlap */}
          <div className="relative z-20 lg:col-span-5 lg:-mt-6 lg:rotate-[1.5deg]">
            ...
            >
              ...
              <div
                aria-hidden
                className="absolute inset-0 bg-[var(--ultramarine)] mix-blend-multiply"
                style={{ opacity: 0.55 }}
              />
              <div
                aria-hidden
                className="absolute inset-0 bg-[var(--ink2)] mix-blend-multiply"
                style={{ opacity: 0.15 }}
              />
              <span className="absolute bottom-2 left-2 bg-[var(--ink2)] px-1.5 py-0.5 font-body text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--paper2)]">
                Fig. 01 — Fertigung
              </span>
            </ExplodingBlock>
          </div>
